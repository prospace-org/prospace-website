...
import { FormForgotPassword } from 'src/components'
import { Container, Grid, Section, Text, Col, Row } from '@bolio-ui/core'
          ...
          <Grid.Container justify="center">
            <Row justify="space-around" style={{ textAlign: 'center' }}>
              <Col>
                ...
                <Text h2>Forgot your password?</Text>
                <Text p mt={0}>
                  Enter the email address to send a recovery email.
                </Text>
              </Col>
            </Row>
          </Grid.Container>
